...
class TestCases(unittest.TestCase):
    ...
    def test_RemoveCycles(self):
        ...
        expanded_paths = remove_cycles([Path([7, 5, 6, 1,
8]), Path([7, 5, 6, 1, 2]), Path([7, 5, 6, 1, 7]), Path([7, 5, 6, 1, 5]), Path([7, 5, 6, 1, 3])])
        self.assertEqual(expanded_paths, [Path([7, 6]), Path([7, 8])])
    ...
    def test_breadth_first_search(self):
        route1 = breadth_first_search(16, 11, self.map)
    ...
    def test_coord2station(self):
        stationID = coord2station([14,166], self.map)
    ...
    def test_Astar(self):
        ...
        optimal_path = Astar([88,69], [143,195], self.map, 1)
        print(optimal_path.route, optimal_path.g)
